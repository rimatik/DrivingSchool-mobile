 ...
 */
public class PrometniPolicajacAdapter extends BaseAdapter {

    private Context context;
    private List<Semafor> semafori;

    public PrometniPolicajacAdapter(Context context, List<Semafor> semafori) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.list_item_prometni_policajac, viewGroup, false);
